...
[[Fig2.]] An illustrated example in the AAIndex database
...
a Dipole scale (Debye): $-$, Dipole<1.0; $+$, 1.0<Dipole<2.0; $++$, 2.0<Dipole<3.0; $+++$, Dipole>3.0; $+'+'+'$, Dipole>3.0 with opposite orientation. b Volume scale (\AA$^3$): $-$, Volume<50; $+$, Volume> 50. c Cys is separated from class 3 because of its ability to form disulfide bonds.
...
$$
X_r = \frac{w \tau_{d-20}}{\sum_{r=1}^{20} f_r + w \sum_{d=1}^{\textrm{maxlag}} \tau_d} quad d = 21, 22, \ldots, 20 + \textrm{maxlag}
$$
